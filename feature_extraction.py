...
# 1 DEFINE A FUNCTION THAT OPENS A FILE AND RETURNS THE CONTENT
...
# 4 RUN 1,2,3 STEPS FOR ALL HTML FILES AND CREATE A 2-D ARRAY

folder = "mini_dataset"

def create_2d_array(folder_name):
...
# 5 CREATE A DATAFRAME BY USING 2D ARRAY
