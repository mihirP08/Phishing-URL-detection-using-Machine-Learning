...
with open("mini_dataset/9.html", encoding="utf-8") as f:
    test = f.read()
...
print("has_h1 --> ", has_h1(soup))
print("has_h2 --> ", has_h2(soup))
print("has_h3 --> ", has_h3(soup))
print("len_of_text --> ", length_of_text(soup))
print("number_of_clickable_button --> ", number_of_clickable_button(soup))
print("number_of_a --> ", number_of_a(soup))
print("number_of_img --> ", number_of_img(soup))
print("number_of_div --> ", number_of_div(soup))
print("number_of_figure --> ", number_of_figure(soup))
print("has_footer --> ", has_footer(soup))
print("has_form --> ", has_form(soup))
print("has_text_area --> ", has_text_area(soup))
print("has_iframe --> ", has_iframe(soup))
print("has_text_input --> ", has_text_input(soup))
print("number_of_meta --> ", number_of_meta(soup))
print("has_nav --> ", has_nav(soup))
print("has_object --> ", has_object(soup))
print("has_picture --> ", has_picture(soup))
print("number_of_sources --> ", number_of_sources(soup))
print("number_of_span --> ", number_of_span(soup))
print("number_of_table --> ", number_of_table(soup))
# print("length_of_title --> ", length_of_title(soup))